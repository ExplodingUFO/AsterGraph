...
- [x] **DEMO-03**: The scenario demo exercises custom nodes, parameter editing, connection validation, plugin/trust visibility, save/load, automation/proof output, and export from one coherent product story.
- [x] **DEMO-04**: The Demo host exposes a guided tour or equivalent scenario flow that walks through creating nodes, connecting them, editing parameters, loading plugin content, and exporting output.
