# Roadmap Archive: v1.4 Plugin Loading and Automation Execution

**Reconstructed:** 2026-04-16
**Source snapshot:** `5622eb7` (`docs: create milestone v1.4 roadmap (4 phases)`)

The historical roadmap snapshot is preserved below as it was originally framed before `v1.4` shipped.
