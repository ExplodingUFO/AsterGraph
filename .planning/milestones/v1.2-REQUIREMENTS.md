# Requirements Archive: v1.2 Kernel Extraction, Capability Contracts, and Plugin Readiness
...
- All 11 milestone requirements shipped and are marked complete.
- Deferred follow-on work remains `PLUG-01`, `AUTO-01`, and `WB-01`.
- Milestone completion proceeded from complete phase summaries and proof outputs; no standalone `v1.2` audit file was present at archive time.

For active requirements, create a new `.planning/REQUIREMENTS.md` with `$gsd-new-milestone`.
...
- [x] **PLUG-READY-01**: The resulting architecture leaves runtime plugin loading and richer automation on top of explicit kernel/capability seams rather than another round of facade-bound refactors
