...
internal static class ConsumerSampleDocsAssertions
{
    internal static void AssertSupportBundleProofMarkers(string contents)
    {
        ...
        Assert.Contains("WORKBENCH_ADOPTER_POLISH_HANDOFF_OK:True", contents, StringComparison.Ordinal);
        Assert.Contains("WORKBENCH_ADOPTER_POLISH_SCOPE_BOUNDARY_OK:True", contents, StringComparison.Ordinal);
        Assert.Contains("V064_MILESTONE_PROOF_OK:True", contents, StringComparison.Ordinal);
