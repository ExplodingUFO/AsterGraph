...
public sealed class DemoCookbookProofClosureTests
{
    ...
    public void DemoCookbookProof_Run_EmitsGreenClosureMarkers()
    {
        ...
        Assert.True(result.ScenarioDepthOk);
    ...
    public void DemoCookbookProof_PublicMarkersCoverPolishedCookbookClosure()
    {
        ...
        Assert.Contains("DEMO_COOKBOOK_SCENARIO_DEPTH_OK", DemoCookbookProof.PublicSuccessMarkerIds);
    ...
    public void CookbookClosure_StaysInNarrowOwnedFiles()
    {
        ...
        var ownedFiles = new[]
        {
            ...
            "tests/AsterGraph.Demo.Tests/LayoutProviderProofDocsTests.cs",
            "tests/AsterGraph.Demo.Tests/RendererVirtualizationProofDocsTests.cs",
            ...
            "tests/AsterGraph.Demo.Tests/DemoCookbookScenarioCueTests.cs",
