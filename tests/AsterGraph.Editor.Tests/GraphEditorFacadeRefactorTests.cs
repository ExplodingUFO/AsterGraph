...
public sealed class GraphEditorFacadeRefactorTests
{
    ...
    [Fact]
    public void EditorAssembly_ContainsDedicatedKernelProjectionHost()
    {
        var hostType = typeof(GraphEditorViewModel).GetNestedType(
            "GraphEditorViewModelKernelProjectionHost",
            System.Reflection.BindingFlags.NonPublic);
    ...
    [Fact]
    public void EditorAssembly_ContainsDedicatedSelectionCoordinatorHost()
    {
        var hostType = typeof(GraphEditorViewModel).GetNestedType(
            "GraphEditorViewModelSelectionCoordinatorHost",
            System.Reflection.BindingFlags.NonPublic);
    ...
    [Fact]
    public void EditorAssembly_ContainsDedicatedNodePositionDirtyTrackerHost()
    {
        var hostType = typeof(GraphEditorViewModel).GetNestedType(
            "GraphEditorViewModelNodePositionDirtyTrackerHost",
            System.Reflection.BindingFlags.NonPublic);
    ...
    [Fact]
    public void EditorAssembly_ContainsDedicatedRetainedEventPublisherHost()
    {
        var hostType = typeof(GraphEditorViewModel).GetNestedType(
            "GraphEditorViewModelRetainedEventPublisherHost",
            System.Reflection.BindingFlags.NonPublic);
    ...
    [Fact]
    public void GraphEditorAssembly_ContainsDedicatedNodeLayoutCoordinatorHost()
    {
        var hostType = typeof(GraphEditorViewModel).GetNestedType(
            "GraphEditorViewModelNodeLayoutCoordinatorHost",
            System.Reflection.BindingFlags.NonPublic);
    ...
    [Fact]
    public void GraphEditorViewModel_DoesNotImplementSelectionCoordinatorHostInterface()
    {
        var viewModelType = typeof(GraphEditorViewModel);
        var implementedInterfaces = viewModelType.GetInterfaces();
        ...
        Assert.DoesNotContain(
            implementedInterfaces,
            iface => iface.FullName == "AsterGraph.Editor.Services.IGraphEditorSelectionCoordinatorHost");
    }
    ...
    [Fact]
    public void GraphEditorViewModel_DoesNotImplementKernelProjectionHostInterface()
    {
        var viewModelType = typeof(GraphEditorViewModel);
        var implementedInterfaces = viewModelType.GetInterfaces();
        ...
        Assert.DoesNotContain(
            implementedInterfaces,
            iface => iface.FullName == "AsterGraph.Editor.Services.IGraphEditorKernelProjectionHost");
    }

    [Fact]
    public void GraphEditorViewModel_DoesNotImplementNodeLayoutCoordinatorHostInterface()
    {
        var viewModelType = typeof(GraphEditorViewModel);
        var implementedInterfaces = viewModelType.GetInterfaces();
        ...
        Assert.DoesNotContain(
            implementedInterfaces,
            iface => iface.FullName == "AsterGraph.Editor.Services.IGraphEditorNodeLayoutCoordinatorHost");
    }
    ...
    public void GraphEditorViewModel_DoesNotImplementNodePositionDirtyTrackerHost()
    {
        ...
        Assert.DoesNotContain(
            implementedInterfaces,
            iface => iface.FullName == "AsterGraph.Editor.Services.IGraphEditorNodePositionDirtyTrackerHost");
    }

    [Fact]
    public void GraphEditorViewModel_DoesNotImplementRetainedEventPublisherHost()
    {
        var viewModelType = typeof(GraphEditorViewModel);
        var implementedInterfaces = viewModelType.GetInterfaces();
        ...
        Assert.DoesNotContain(
            implementedInterfaces,
            iface => iface.FullName == "AsterGraph.Editor.Services.IGraphEditorRetainedEventPublisherHost");
    }
