...
public static class AsterGraphAvaloniaViewFactory
{
    ...
    public static GraphEditorView Create(AsterGraphAvaloniaViewOptions options)
    {
        ...
        return new GraphEditorView
        {
            ...
            IsLibraryChromeVisible = workbench.ShowNodePalette && workbench.PanelState.StencilVisible,
            IsInspectorChromeVisible = workbench.ShowInspector && workbench.PanelState.InspectorVisible,
