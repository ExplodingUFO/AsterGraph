...
internal static class GraphEditorCommandDescriptorCatalog
{
    private static readonly IReadOnlyDictionary<string, GraphEditorCommandDescriptorMetadata> MetadataById =
        new Dictionary<string, GraphEditorCommandDescriptorMetadata>(StringComparer.Ordinal)
        {
            ...
            ["selection.select-all"] = new("Select All", "selection", "select-all", "Ctrl+A"),
            ["selection.select-none"] = new("Select None", "selection", "select-none", "Ctrl+Shift+A"),
            ["selection.invert"] = new("Invert Selection", "selection", "invert", "Ctrl+I"),
            ...
            ["viewport.zoom-in"] = new("Zoom In", "viewport", "zoom-in", "Ctrl+OemPlus"),
            ["viewport.zoom-out"] = new("Zoom Out", "viewport", "zoom-out", "Ctrl+OemMinus"),
            ["viewport.pan-left"] = new("Pan Left", "viewport", "pan", "Ctrl+Left"),
            ["viewport.pan-right"] = new("Pan Right", "viewport", "pan", "Ctrl+Right"),
            ["viewport.pan-up"] = new("Pan Up", "viewport", "pan", "Ctrl+Up"),
            ["viewport.pan-down"] = new("Pan Down", "viewport", "pan", "Ctrl+Down"),
            ["viewport.center-node"] = new("Center On Node", "viewport", "center", null),
            ["viewport.center"] = new("Center View", "viewport", "center", null),
            ["viewport.focus-node"] = new("Focus Node", "viewport", "focus", null),
            ["viewport.focus-issue"] = new("Focus Issue", "viewport", "focus", null),
            ["viewport.focus-search-result"] = new("Focus Search Result", "viewport", "focus", null),
            ["viewport.bookmark.add"] = new("Add View Bookmark", "viewport", "bookmark", null),
            ["viewport.bookmark.remove"] = new("Remove View Bookmark", "viewport", "bookmark", null),
            ["viewport.bookmark.activate"] = new("Activate View Bookmark", "viewport", "bookmark", null),
