...
public sealed partial class GraphEditorSession : IGraphEditorSession, IGraphEditorAutomationRunner, IGraphEditorCommands, IGraphEditorQueries, IGraphEditorEvents, IGraphEditorDiagnostics
{
    ...
    private readonly GraphEditorSessionAutomationExecutorHost _automationExecutorHost;
    private readonly GraphEditorSessionAutomationExecutor _automationExecutor;
        ...
        GraphEditorSessionDescriptorSupport? descriptorSupport = null)
    {
        ...
        _automationExecutorHost = new GraphEditorSessionAutomationExecutorHost(this);
        _automationExecutor = new GraphEditorSessionAutomationExecutor(_automationExecutorHost);
    ...
    public GraphEditorAutomationExecutionSnapshot Execute(GraphEditorAutomationRunRequest request)
        => _automationExecutor.Execute(request);
