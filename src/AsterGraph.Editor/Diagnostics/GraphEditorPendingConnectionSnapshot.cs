...
public sealed record GraphEditorPendingConnectionSnapshot
{
    ...
    /// <summary>
    /// 基于原始待完成连线、当前悬停目标状态和稳定拒绝原因创建一个经过归一化的快照。
    /// </summary>
    public static GraphEditorPendingConnectionSnapshot Create(
        bool hasPendingConnection,
        string? sourceNodeId,
        ...
        => new(
            ...
            hasPendingConnection ? isTargetCompatible : null,
            hasPendingConnection ? validationMessage : null,
            hasPendingConnection ? rejectionReason : GraphEditorPendingConnectionRejectionReason.None);
    ...
    public GraphEditorPendingConnectionSnapshot(
        ...
        : this(
            ...
            null,
            null,
            GraphEditorPendingConnectionRejectionReason.None)
    {
    }
    ...
    /// <param name="isTargetCompatible">当前悬停目标是否兼容。</param>
    /// <param name="validationMessage">当前悬停目标的连接校验说明。</param>
    /// <param name="rejectionReason">当前悬停目标被拒绝时的稳定原因。</param>
    public GraphEditorPendingConnectionSnapshot(
        bool hasPendingConnection,
        string? sourceNodeId,
        string? sourcePortId,
        ...
        GraphEditorPendingConnectionRejectionReason rejectionReason)
    {
        ...
        RejectionReason = hasPendingConnection && isTargetCompatible == false
            ? rejectionReason
            : GraphEditorPendingConnectionRejectionReason.None;
    }
    ...
    /// 当前悬停目标被拒绝时的稳定原因。
    /// </summary>
    public GraphEditorPendingConnectionRejectionReason RejectionReason { get; }
