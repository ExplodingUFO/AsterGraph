...
public sealed record GraphEditorInspectionSnapshot
{
    ...
    /// <param name="validationSnapshot">当前文档验证与就绪状态快照。</param>
    public GraphEditorInspectionSnapshot(
        ...
        GraphEditorValidationSnapshot? validationSnapshot = null)
    {
        ...
        ValidationSnapshot = validationSnapshot ?? GraphEditorValidationSnapshot.Empty;
    }
    ...
    /// 当前文档验证与就绪状态快照。
    /// </summary>
    public GraphEditorValidationSnapshot ValidationSnapshot { get; }
}
