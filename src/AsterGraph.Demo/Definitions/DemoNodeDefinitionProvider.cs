            ...
            new NodeDefinition(
                ...
                [
                    ...
                    new NodeParameterDefinition(
                        ...
                        new PortTypeId("float"),
                        ParameterEditorKind.Number,
                        description: "Inline fallback literal used when the pulse input is not connected.",
                        defaultValue: 0.2,
                    ...
                    new NodeParameterDefinition(
                        ...
                        new PortTypeId("float"),
                        ParameterEditorKind.Number,
                        description: "Inline authoring value shown directly on the expanded node when no rim mask is wired.",
                        defaultValue: 0.68,
                        constraints: new ParameterConstraints(Minimum: 0, Maximum: 1),
                        groupName: "Inputs"),
                ],
