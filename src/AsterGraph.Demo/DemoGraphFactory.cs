    ...
    public static GraphDocument CreateDefault(INodeCatalog catalog)
        => new(
            ...
            [
                ...
                CreateNode(catalog, "noise", new NodeDefinitionId("aster.demo.noise-field"), new GraphPoint(360, 40)),
                CreateNode(catalog, "gradient", new NodeDefinitionId("aster.demo.palette-ramp"), new GraphPoint(340, 300)),
