...
`DEMO_COOKBOOK_SCENARIO_DEPTH_OK` and `DEMO_COOKBOOK_LAYOUT_SERVICES_OK` prove the cookbook's scenario points cover the required professional depth while keeping Demo bounded as a sample/proof surface:
