...
If you need bounded adapter-2 follow-up after the defended Avalonia proof, run `AsterGraph.HelloWorld.Wpf -- --proof` after step 4 and keep `HOSTED_ACCESSIBILITY_BASELINE_OK:True`, `HOSTED_ACCESSIBILITY_FOCUS_OK:True`, `HOSTED_ACCESSIBILITY_COMMAND_SURFACE_OK:True`, `HOSTED_ACCESSIBILITY_AUTHORING_SURFACE_OK:True`, `HOSTED_ACCESSIBILITY_OK:True`, `ADAPTER2_PERFORMANCE_BASELINE_OK:True`, `ADAPTER2_PROJECTION_BUDGET_OK:True:none`, `ADAPTER2_COMMAND_BUDGET_OK:True:none`, `ADAPTER2_SCENE_BUDGET_OK:True:none`, and `HELLOWORLD_WPF_OK:True` on that same local record; see [Adapter-2 Accessibility Recipe](./adapter-2-accessibility-recipe.md) and [Adapter-2 Performance Recipe](./adapter-2-performance-recipe.md).
