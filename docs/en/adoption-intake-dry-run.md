...
These synthetic dry-run rehearsal records keep the bounded intake fields together: route, version, proof markers, friction, support-bundle attachment note, and claim-expansion status. They are fixtures only and are not external validation or adopter evidence.
