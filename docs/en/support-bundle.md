...
For screen-reader-ready local evaluation, keep this bundle on the same bounded intake record as the post-ladder `HostSample` lines `HOST_SAMPLE_AUTOMATION_OK:True` and `HOST_SAMPLE_ACCESSIBILITY_BASELINE_OK:True`.
