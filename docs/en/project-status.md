...
- next recommended work line: v0.64 should be adopter-driven Workbench polish, starting from the highest-friction hosted workflow observed in real usage while preserving the existing hosted workbench seams rather than adding WPF parity, marketplace, sandboxing, macro/query, execution-engine, or GA scope.
