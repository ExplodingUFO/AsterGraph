...
- next recommended work line: v0.67 should be Repairability, Help, and Review UX, starting from validation repair and contextual help loops while preserving the existing hosted workbench seams rather than adding WPF parity, marketplace, sandboxing, macro/query, execution-engine, or GA scope.
