...
| `workbench.stencil.basic` | Workbench | Beta | session stencil discovery 和 insertion commands | Supported | Fallback | `AsterGraph.Demo` | `CAPABILITY_BREADTH_STENCIL_OK:True` | 通过 command/search budget 防守 `large` | [Capability Breadth Recipe](./capability-breadth-recipe.md) |
