...
- v0.60 adapter-2 validation handoff markers：`ADAPTER2_VALIDATION_HANDOFF_OK:True`、`ADAPTER2_VALIDATION_SCOPE_BOUNDARY_OK:True` 和 `V060_MILESTONE_PROOF_OK:True`
...
当前 v0.61 handoff markers：`ADOPTION_API_STABILIZATION_HANDOFF_OK:True`、`ADOPTION_API_SCOPE_BOUNDARY_OK:True` 和 `V061_MILESTONE_PROOF_OK:True`。
