...
interaction feedback proof 还应该包含 `INTERACTION_FEEDBACK_OK:True` 和 `CANVAS_FOCUS_RECOVERY_OK:True`，证明可见 affordance 和 focus recovery 证据仍走现有 canvas、command 和 navigation 路线。
