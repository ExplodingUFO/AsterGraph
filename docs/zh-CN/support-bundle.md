...
v0.64 workbench polish handoff proof 还应该包含 `WORKBENCH_ADOPTER_POLISH_HANDOFF_OK:True`、`WORKBENCH_ADOPTER_POLISH_SCOPE_BOUNDARY_OK:True` 和 `V064_MILESTONE_PROOF_OK:True`，只汇总本地 hosted workbench evidence。
