...
navigation proof 仍然是宿主自管：`NAVIGATION_HISTORY_OK:True`、`SCOPE_BREADCRUMB_NAVIGATION_OK:True` 和 `FOCUS_RESTORE_OK:True` 只证明 back/forward、breadcrumb 和 focus-restore 证据，不代表新增 runtime navigation API。
