...
- 把 `ADAPTER2_PERFORMANCE_BASELINE_OK:True`、`ADAPTER2_PROJECTION_BUDGET_OK:True:none`、`ADAPTER2_COMMAND_BUDGET_OK:True:none`、`ADAPTER2_SCENE_BUDGET_OK:True:none` 和 `HELLOWORLD_WPF_OK:True` 继续放在同一条本地记录里。
