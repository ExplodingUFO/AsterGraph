...
The proof sample evidence markers `ADAPTER2_WPF_SAMPLE_PROOF_OK:True`,
`ADAPTER2_CANONICAL_ROUTE_OK:True`, and `ADAPTER2_SAMPLE_SCOPE_BOUNDARY_OK:True` keep the
sample copyable and tied to the canonical session/runtime route.
