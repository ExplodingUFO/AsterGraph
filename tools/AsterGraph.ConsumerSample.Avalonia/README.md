...
The authoring flow handoff summarizes quick-add connected nodes, insert-on-wire, reconnect editing, edge multiselect, and wire slicing on the existing session command path.
...
- `RUNTIME_OVERLAY_SCOPE_FILTER_OK:True`
...
- `INTERACTION_SUPPORT_BUNDLE_OK:True`
...
- `NODE_DEFINITION_BUILDER_OK:True`
- `PORT_DEFINITION_BUILDER_OK:True`
- `PARAMETER_DEFINITION_BUILDER_OK:True`
- `CONNECTION_RULE_BUILDER_OK:True`
- `AUTHORING_BUILDER_THIN_WRAPPER_OK:True`
...
- `MINIMAP_LIGHTWEIGHT_PROJECTION_EVIDENCE_OK:True`
