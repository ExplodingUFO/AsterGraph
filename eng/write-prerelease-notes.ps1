...
[void]$builder.AppendLine("- next 0.xx alpha/beta line: keep usability and sample polish first, and only widen toward defended large-tier performance or richer parameter/metadata editing when 3-5 real external entries cluster on that bounded risk")
