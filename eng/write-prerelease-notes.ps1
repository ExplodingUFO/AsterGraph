...
[void]$builder.AppendLine("- current 0.xx alpha/beta hardening line: `Performance / Export Hardening` means conservative 5000-node raster export budgets first, then progress/cancel/scope evidence before rendering cache claims; `xlarge` remains telemetry-only, not a 10000-node support or virtualization claim")
