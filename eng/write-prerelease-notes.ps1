...
[void]$builder.AppendLine("- current 0.xx alpha/beta hardening line: `Repairability, Help, and Review UX` means validation repair, contextual help, support-bundle evidence, support boundary, and release proof gates stay aligned before release-candidate, GA, or `1.0` language; `GRAPH_ERROR_HELP_TARGET_OK:True`, `GRAPH_PROBLEM_INSPECTOR_HELP_TARGET_OK:True`, `REPAIR_HELP_REVIEW_LOOP_OK:True`, `ADOPTION_RECOMMENDATION_CURRENT_OK:True`, `CLAIM_HYGIENE_BOUNDARY_OK:True`, `RELEASE_READINESS_GATE_OK:True`, `SUPPORT_BOUNDARY_GATE_OK:True`, `BETA_CLAIM_ALIGNMENT_OK:True`, `ADOPTION_API_STABILIZATION_HANDOFF_OK:True`, `ADOPTION_API_SCOPE_BOUNDARY_OK:True`, and `V061_MILESTONE_PROOF_OK:True` remain the boundary proof handoff markers; `xlarge` remains telemetry-only, not a 10000-node support or virtualization claim")
